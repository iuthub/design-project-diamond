      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            ...
            <p><a href="#" target="_blank" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#reservationModal">Reservation</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 site-animate img" data-animate-effect="fadeInRight">
            <img src="{{ asset('images/about_img_1.jpg') }}" alt="DIAMOND" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="owl-carousel site-owl">
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center site-media site-animate border-0">
                  <img src="{{ asset('images/offer_1.jpg') }}" alt="DIAMOND" class="img-fluid">
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center site-media site-animate border-0">
                  <img src="{{ asset('images/offer_2.jpg') }}" alt="DIAMOND" class="img-fluid">
                  <div class="media-body p-md-5 p-4">
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center site-media site-animate border-0">
                  <img src="{{ asset('images/offer_3.jpg') }}" alt="DIAMOND" class="img-fluid">
                  <div class="media-body p-md-5 p-4">
                ...
                <div class="row">
                  <div class="col-md-6 site-animate">
                    <div class="media menu-item">
                      <img class="mr-3" src="{{ asset('images/menu_1.jpg') }}" class="img-fluid" alt="DIAMOND">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="{{ asset('images/menu_2.jpg') }}" class="img-fluid" alt="DIAMOND">
                      <div class="media-body">
                    ...
                    <div class="media menu-item">
                      <img class="mr-3" src="{{ asset('images/menu_3.jpg') }}" class="img-fluid" alt="DIAMOND">
                      <div class="media-body">
      ...
      <div class="container">
        <div class="row site-custom-gutters">
          ...
          <div class="col-md-4 site-animate">
            <a href="eatwell/images/menu_1.jpg" class="site-thumbnail image-popup">
              <img src="{{ asset('images/menu_1.jpg') }}" alt="DIAMOND" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 site-animate">
            <a href="eatwell/images/menu_2.jpg" class="site-thumbnail image-popup">
              <img src="{{ asset('images/menu_2.jpg') }}" alt="DIAMOND" class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 site-animate">
            <a href="eatwell/images/menu_3.jpg" class="site-thumbnail image-popup">
              <img src="{{ asset('images/menu_3.jpg') }}" alt="DIAMOND" class="img-fluid">
            </a>
          </div>
    ...
    <section class="site-section bg-light" id="section-contact">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-1"></div>
          <div class="col-md-4 site-animate">
            <p><img src="{{ asset('images/about_img_1.jpg') }}" alt="" class="img-fluid"></p>
            <p class="text-black">
